...
Source0  : https://files.pythonhosted.org/packages/aa/51/59965dead3960a97358f289c7c11ebc1f6c5d28710fab5d421000fe60353/asttokens-2.0.5.tar.gz
...
%prep
%setup -q -n asttokens-2.0.5
cd %{_builddir}/asttokens-2.0.5
pushd ..
cp -a asttokens-2.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653002844
...
cp %{_builddir}/asttokens-2.0.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-asttokens/92170cdc034b2ff819323ff670d3b7266c8bffcd
