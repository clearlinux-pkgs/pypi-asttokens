...
Source0  : https://files.pythonhosted.org/packages/c8/a8/897876e62ff3e796ca948ab7e6d99e03dfed256da87da557c35f12b9ef7e/asttokens-2.2.0.tar.gz
...
%prep
%setup -q -n asttokens-2.2.0
cd %{_builddir}/asttokens-2.2.0
pushd ..
cp -a asttokens-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669819195
