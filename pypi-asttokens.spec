...
Source0  : https://files.pythonhosted.org/packages/ff/b9/40d8b5f23c59def4f4a67a807e899e00200db11f63b4ac9bde5838b709de/asttokens-2.1.0.tar.gz
...
%prep
%setup -q -n asttokens-2.1.0
cd %{_builddir}/asttokens-2.1.0
pushd ..
cp -a asttokens-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667226430
